...
def main() -> None:
    ...
    with col3: st.page_link("pages/3_Keyword_Analysis.py", label="Keyword Analysis", icon="🔑")
    ...
    with col3: st.page_link("pages/8_Quality_Evaluation.py", label="Quality Eval", icon="🔬")
