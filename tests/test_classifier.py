...
class TestKeywordClassify:
    ...
    def test_strong_rag_signal(self):
        """RAG and agents should strongly classify as Applications."""
    ...
    def test_model_release(self):
        """Model release keywords should classify as AI Models."""
    ...
    def test_infrastructure_gpu(self):
        """GPU and chip keywords should classify as Infrastructure."""
    ...
    def test_business_funding(self):
        """Funding and acquisition keywords should classify as Business."""
        result = keyword_classify("AI startup raises $500M in funding", "The valuation reached $5B after the latest investor deal.")
        assert result == "AI Companies & Business"

    def test_policy_regulation(self):
        """Regulation keywords should classify as Government & Policy."""
